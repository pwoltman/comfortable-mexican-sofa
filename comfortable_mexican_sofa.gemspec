...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'rails-i18n',        '>= 4.0.0', '<= 5.3'
  s.add_dependency 'bootstrap_form',    '>= 2.2.0', '<= 2.7'
  s.add_dependency 'active_link_to',    '>= 1.0.0', '<= 1.1'
  s.add_dependency 'paperclip',         '>= 4.0.0'
  s.add_dependency 'kramdown',          '>= 1.0.0', '<= 1.17'
